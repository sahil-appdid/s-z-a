                ...
                <div class="tm_invoice_in">
                    <div class="tm_invoice_head tm_align_center tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo">
                                <img src="https://shop-aleafiaa.heenahealth.in/images/logo/shopp-aleafia.png"
                                    alt="Logo">
                            </div>
                        </div>
                        <div class="tm_invoice_right tm_text_right">
                            <div class="tm_primary_color tm_f50 tm_text_uppercase"
                                style="position: absolute;right:0;top:0;">Tax Invoice</div>
                        </div>
                    </div>
                    <div class="tm_invoice_info tm_mb20">
                        ...
                        <div class="tm_invoice_info_list">
                            <p class="tm_invoice_number tm_m0"
                                style="position: absolute;right:10rem; margin-top:-20px;">Invoice No: <b
                                    class="tm_primary_color">#LL93784</b></p>
                            <p class="tm_invoice_date tm_m0" style="position: absolute;right:0; margin-top:-20px;">Date:
                                <b class="tm_primary_color">01.07.2022</b>
                            </p>
                        </div>
                    </div>
                    <div class="tm_invoice_head tm_mb10 d-flex">
                        <div class="tm_invoice_left">
                        ...
                        <div class="" style="position: absolute;top:80;left:250px">
                            <p class="tm_mb2"><b class="tm_primary_color">Place Of Supply</b></p>
                            <p>
                                Gujarat
                            </p>
                        </div>
                        <div class="tm_invoice_right tm_text_right" style="right: 0;position:absolute;margin-top:-9rem">
                    ...
                    <div class="tm_table tm_style1 tm_mb30">
                        <div class="tm_round_border">
                            <div class="tm_table_responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">Sr</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">Description</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">HSN</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">MRP</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">Rate</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">Qty</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">Amount</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">Taxable Amount</th>
                                            <th class=" tm_semi_bold tm_primary_color tm_gray_bg">GST</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="">1</td>
                                            <td class="">Moxiking CV 375
                                                <div style="margin-top:5px;">
                                                    <table style="width:60%;">
                                                        <thead>
                                                            <tr>
                                                                <th style="padding: 0;font-size:10px;width:40px">Batch
                                                                </th>
                                                                <th style="padding: 0;font-size:10px;width:40px">Qty
                                                                </th>
                                                                <th style="padding: 0;font-size:10px;width:40px">MFD
                                                                </th>
                                                                <th style="padding: 0;font-size:10px;">EXP</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding: 0;font-size:10px;">B3456</td>
                                                                <td style="padding: 0;font-size:10px;">1</td>
                                                                <td style="padding: 0;font-size:10px;">11/06</td>
                                                                <td style="padding: 0;font-size:10px;">12/10</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 0;font-size:10px;">B3456</td>
                                                                <td style="padding: 0;font-size:10px;">1</td>
                                            ...
                                            <td class="">350</td>
                                            <td class="">350</td>
                                            <td class="">350.10 (18%)</td>
                                        </tr>
                                        <tr>
                                            <td class="">2</td>
                                            <td class="">Evion (Vitamin C)
                                                <div style="margin-top:5px;">
                                                    <table style="width:60%;">
                                                        <thead>
                                                            <tr>
                        ...
                        <div class="tm_invoice_footer" style="display: inline-block;width: 100%;">
                            <div>
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class=" tm_primary_color tm_border_none tm_bold">Subtoal</td>
                                            <td class=" tm_primary_color tm_text_right tm_border_none tm_bold">
                                                1650</td>
                                        </tr>
                                        <tr>
                                            <td class=" tm_primary_color tm_border_none tm_pt0">Tax <span
                                                    class="tm_ternary_color">(5%)</span></td>
                                            <td class=" tm_primary_color tm_text_right tm_border_none tm_pt0">
                                                +82</td>
                                        </tr>
                                        <tr class="tm_border_top tm_border_bottom">
                                            <td class=" tm_border_top_0 tm_bold tm_f16 tm_primary_color">Grand
                                                Total </td>
                                            <td class=" tm_border_top_0 tm_bold tm_f16 tm_primary_color tm_text_right">
                                                1732</td>
                                        </tr>
                                    </tbody>
                                </table>
